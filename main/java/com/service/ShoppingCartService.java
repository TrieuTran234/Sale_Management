...
public interface ShoppingCartService {
	 ...
	 */
	void add(Item item,Integer qty);
	...
	/**
	 * Lấy tổng số tiền tất cả các mặt hàng trong giỏ LAB4: SPRING BEANS SOF3021 –
	 * LẬP TRÌNH JAVA 5 TRANG 7
	 */
	double getAmount();

	Item findName(String name);
