...
background-image:url('/admin/img/backroundsuper73.jpg');background-repeat: no-repeat;
    ...
    <div class="u-clearfix u-sheet u-sheet-1" style="margin-left: 27%">
    	...
    	<form:form
				action="/admin/promotion/index"  modelAttribute="item"
				method="POST" enctype="multipart/form-data" class="" source="custom"
				name="form" style="padding: 34px; width: 750px; height:300px;">
				<div class="u-form-group u-form-name">
					<label for="name-6a67" class="u-label u-label-1">PROMOTION ID</label> 
					<form:input
						path="id" name="id" type="text" placeholder="Enter promotion id?"  id="name-6a67" 
						
						class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"
						required="required"/>
				</div><br>
				<div class="u-form-group">
					<label for="email-6a67" class="u-label u-label-2 u-text-white">PROMOTION NAME
						</label> <form:input path="name" name="name" type="text" placeholder="Enter promotion name" id="email-6a67"
						 
						class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"
						required="required"/>
				</div> <br>
				<div class="u-form-group u-form-name">
					<label for="name-6a67" class="u-label u-label-1">Promotion Discount</label> 
					<form:input
						path="discount" name="discount" type="number" placeholder="Enter discount?"  id="name-6a67" 
						
						class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"
						required=""/>
				</div> <br>
				<div class="u-form-group u-form-name">
					<label for="name-6a67" class="u-label u-label-1">To Date</label> 
					<form:input
						path="ToDate" name="discount" type="date" placeholder="Enter To date?"  id="name-6a67" 
						
						class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"
						required=""/>
				</div><br>
				<div class="u-form-group u-form-name">
					<label for="name-6a67" class="u-label u-label-1">From Date</label> 
					<form:input
						path="FromDate" name="fromdate" type="date" placeholder="Enter To date?"  id="name-6a67" 
						
						class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"
						required=""/>
				</div><br>
				 <c:forEach var="item2" items="${product}" >
				<b>${item2.name }</b> <input type="checkbox" value="${item2.id }" name="productname" >
				</c:forEach>
				<br>
                      <div > <b>Active&emsp;&emsp;</b>
						<form:radiobutton path="status"  name="status" 
							class="input-check"  value="true"/> &nbsp;YES &ensp; <form:radiobutton path="status" 
							 name="status" class="input-check"
							 value="false" /> &nbsp;NO
						</div>
                      <br>
				...
				<div class="u-align-left u-form-group u-form-submit">
					<button
						...
						formaction="/admin/promotion/create">Create</button>
					<input type="submit" value="submit" class="u-form-control-hidden">
					<button
						class="u-border-none u-btn u-btn-submit u-button-style u-text-body-alt-color-black  u-btn-1 u-black"
						style="color: black; font-weight: bold"
						formaction="/admin/promotion/update">Update</button>
					<input type="submit" value="submit" class="u-form-control-hidden">
					<button
						class="u-border-none u-btn u-btn-submit u-button-style u-text-body-alt-color-black  u-btn-1 u-black"
						style="color: black; font-weight: bold"
						formaction="/admin/promotion/delete/${item.id}">Delete</button>
					<input type="submit" value="submit" class="u-form-control-hidden">
					<button
						class="u-border-none u-btn u-btn-submit u-button-style u-text-body-alt-color-black  u-btn-1 u-black"
						style="color: black; font-weight: bold"
						formaction="/admin/promotion/index">New</button>
					<input type="submit" value="submit" class="u-form-control-hidden">
				</div>
	 ...
	 </form:form> <br><br><br><br><br><br><br><br><br><br><br><br><br>
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-align-center u-black u-custom-font u-heading-font u-table-header u-table-valign-top u-table-header-1">
              <tr style="height: 45px;">
                ...
                <th class="u-table-cell u-border-2">DISCOUNT </th>
                <th class="u-table-cell u-border-2">DATE </th>
                 <th class="u-table-cell u-border-2">DETAIL </th>
            ...
            <tbody class="u-align-center u-table-body">
             <c:forEach var="item" items="${items}">
              <tr style="height: 78px;">
                ...
                <td class="u-border-2 u-border-grey-75 u-table-cell u-white"> <b> ${item.name }</b></td>
                <td class="u-border-2 u-border-grey-75 u-table-cell u-white"> <b> ${item.discount }</b></td>
                <td class="u-border-2 u-border-grey-75 u-table-cell u-white"> <b> ${item.toDate } =>${item.fromDate } </b></td>
               <td class="u-border-2 u-border-grey-75 u-white u-table-cell-13" ><div style="width:70px ;height:50px;background-color:black ;margin: auto;"> <a href="/admin/promotiondetail/index/${item.id}" style="color: white;font-weight: bolder;" >Detail</a></div></td>
                <td class="u-border-2 u-border-grey-75 u-white u-table-cell-13" ><div style="width:70px ;height:50px;background-color:black ;margin: auto;"> <a href="/admin/promotion/edit/${item.id}" style="color: white;font-weight: bolder;" >Edit</a></div></td>
                <td class="u-border-2 u-border-grey-75 u-white u-table-cell-13"><div style="width:70px ;height:50px;background-color:black ;margin: auto;"><a href="/admin/promotion/delete/${item.id}" style="color:white ;font-weight: bolder;">Delete</a></div></td>
              </tr>
