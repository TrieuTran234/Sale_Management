  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-b689"><div class="u-clearfix u-sheet u-sheet-1">
	...
	s-17-7.626-17-17S14.61,6,23.984,6z"></path></svg>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class=" u-container-style u-expanded-width-xs u-group u-white u-group-1" style="width: 100%;margin-right: 800px ">
          <div class="u-clearfix u-sheet   u-sheet-1">
        <div class="u-expanded-width u-table u-table-responsive ">
        <form action="/admin/staff/list" method="POST" >
        <br>
        
		   <input name="keywords" value="${keywords}" placeholder="Key words?" style="width: 70%">
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-align-center u-black u-custom-font u-heading-font u-table-header u-table-valign-top u-table-header-1">
              <tr style="height: 45px;">
                <th class="u-table-cell u-border-2"> <a href="/admin/staff/list/?field=id" class="u-text-white"> ID</a></th>
                <th class="u-table-cell u-border-2"> <a href="/admin/staff/list/?field=fullname" class="u-text-white"> NAME</a></th>
                ...
                <th class="u-table-cell u-border-2"> <a href="/admin/staff/list/?field=dateofbirth" class="u-text-white"> DATE OF BIRTH</a></th>
                 <th class="u-table-cell u-border-2">ADDRESS</th>
            ...
            <tbody class="u-align-center u-table-body">
             <c:forEach var="item" items="${page.content}">
              <tr style="height: 78px;">
                ...
                <td class="u-border-2 u-border-grey-75 u-white u-table-cell u-table-cell-12">${item.password}</td>
                <td class="u-border-2 u-border-grey-75 u-table-cell"> ${item.email}</td>
                <td class="u-border-2 u-border-grey-75 u-table-cell">${item.gender?'Male':'Female'} </td>
                <td class="u-border-2 u-border-grey-75 u-table-cell"> ${item.admin?'Admin':'User'}</td>
                <td class="u-border-2 u-border-grey-75 u-table-cell"> ${item.dateofbirth}</td>
                <td class="u-border-2 u-border-grey-75 u-table-cell"> ${item.address}</td>
                <td class="u-border-2 u-border-grey-75 u-table-cell"> <img alt="" src="/uploads/${item.image }" style="width: 70px; height: 70px"> </td>
                <td class="u-border-2 u-border-grey-75 u-white u-table-cell-13"><button formaction="/admin/staff/edit/${item.id}" style="width:50px ;height:40px;background-color:black ; color:white ;font-weight: bolder;">Edit</button></td>
              	 <td class="u-border-2 u-border-grey-75 u-white u-table-cell-13"><button formaction="/admin/staff/delete/${item.id}" style="width:50px ;height:40px;background-color:black ; color:white ;font-weight: bolder;">Del</button></td>
              </tr>
          ...
          <div class="row">
			...
			<a href="/admin/staff/list?p=${page.number+1}&field=${field}"
				...
				>NEXT</a>
			<input type="submit" value="submit" class="u-form-control-hidden">
			<a href="/admin/staff/list?p=${page.totalPages-1}&field=${field}"
				class="u-border-none u-btn u-btn-submit u-button-style u-text-body-alt-color-black  u-btn-1 u-black"
				style="color: black; font-weight: bold"
				>LAST</a>
			<input type="submit" value="submit" class="u-form-control-hidden">
