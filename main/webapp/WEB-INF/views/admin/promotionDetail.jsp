...
<link rel="stylesheet" href="/admin/REPORTS.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-b689"><div class="u-clearfix u-sheet u-sheet-1">
	...
	s-17-7.626-17-17S14.61,6,23.984,6z"></path></svg>
       ...
       <section class="u-align-center u-black u-clearfix u-container-style u-opacity u-opacity-70 u-section-5" style="background-image: url('/admin/img/order.JPG');" >
      <div class="    " data-image-width="1434" data-image-height="1100" style="width: 100%">
        <div class="u-container-layout u-container-layout-1">
         <span class="u-file-icon u-icon u-icon-circle u-text-palette-1-base u-icon-1"><img src="/admin/img/logo.png" ></span>
          <h2 class="u-custom-font u-font-oswald u-text u-text-body-alt-color u-text-2">PROMOTION DETAIL</h2>
              ...
              <table class="u-table-entity u-white">
                        ...
                        <thead class="u-custom-font u-heading-font u-table-header u-table-header-2">
                          <tr style="height: 47px;">
                            ...
                            <th class="u-border-2 u-border-black u-table-cell">PROMOTION ID</th>
                            <th class="u-border-2 u-border-black u-table-cell">PRODUCT ID</th>
                            <th class="u-border-2 u-border-black u-table-cell">PRODUCT NAME</th>
                        ...
                        <tbody class="u-table-body">
                         <c:forEach var="item" items="${items}">
                          <tr style="height: 47px;">
                            <td class="u-border-2 u-border-grey-90 u-table-cell u-table-cell-21">${item.id }</td>
                            <td class="u-border-2 u-border-grey-90 u-table-cell">${item.promotion.id }</td>
                            <td class="u-border-2 u-border-grey-90 u-palette-3-light-3 u-table-cell u-table-cell-23"> ${item.product.id }</td>
                            <td class="u-border-2 u-border-grey-90 u-table-cell"> ${item.product.name } </td>
                            <td class="u-border-2 u-border-grey-90 u-table-cell"> <a href="/admin/promotiondetail/delete/${item.id}/${item.promotion.id}">DELETE </a></td>
                          </tr>
                         </c:forEach>
                        </tbody>
                      </table>
        ...
        </div><a href="/admin/promotion/index" class=" u-icon u-text-white u-icon-2" ><i class="fa fa-close"></i></a>
      </div>
    </section>  
