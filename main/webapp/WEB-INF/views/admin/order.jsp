        ...
        <div class="u-expanded-width u-tab-links-align-justify u-tabs u-tabs-1 ">
          <ul class="u-border-2 u-border-palette-2-base u-spacing-10 u-tab-list u-unstyled" role="tablist">
            <li class="u-tab-item" role="presentation">
              <a class="active u-active-black u-button-style u-tab-link u-text-active-white u-text-hover-palette-2-base u-tab-link-1" id="link-tab-0da5" href="#tab-0da5" role="tab" aria-controls="tab-0da5" aria-selected="true">ORDER Pending</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-black u-button-style u-tab-link u-text-active-white u-text-hover-palette-2-base u-tab-link-2" id="link-tab-14b7" href="#tab-14b7" role="tab" aria-controls="tab-14b7" aria-selected="false">ORDER are being delivered</a>
            </li>
            <li class="u-tab-item" role="presentation">
                        ...
                        <tbody class="u-table-body">
                          ...
                          <tr style="height: 47px;">
                            ...
                            <td class="u-border-2 u-border-grey-90 u-table-cell" > 
                             ...
                             <td class="u-border-2 u-border-grey-90 u-table-cell" >  
                             <a href="/admin/orderupdate/dg/${item.id }" class="u-align-right u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn  u-palette-4-base u-none u-text-black u-btn-23"><span class="u-file-icon u-icon u-icon-16"><img src="images/10591571.png" alt=""></span>&nbsp;Delivery
              				</a>
                             </td>
                          </tr>
						</c:forEach>	
                ...
                <div class="u-container-style u-expanded-width u-group u-group-2">
                  <div class="u-container-layout">
                    <div class="u-form u-form-2">
                      <form action="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/ReportManagementServlet" method="POST" >
                        <div class="u-form-group u-form-select u-label-none u-form-group-3">
                          ...
                          <div class="u-form-select-wrapper">
                            <select id="videotitle" name="videotitle"  onclick="this.form.submit" class="u-border-1 u-border-black u-input u-input-rectangle u-radius-17" >
                        ...
                        <div class="u-form-group u-form-submit" >
                          <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-hover-grey-90 u-black u-text-white u-btn-2">Submit</a>
