...
<link rel="stylesheet" href="/admin/VIDEO-LIST.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-b689"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <a href="ADMINISTRATION-TOOL.jsp" data-page-id="2560929011" class="u-border-active-palette-2-base u-border-hover-palette-1-base u-border-none u-btn u-btn-round u-button-style u-custom-font u-font-roboto u-palette-3-light-1 u-radius-16 u-text-body-alt-color u-text-hover-black u-btn-1">ADMINISTATION TOOL</a>
          ...
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-align-center u-black u-container-style u-inner-container-layout u-opacity u-opacity-90 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-spacing-9 u-text-hover-palette-3-light-1 u-unstyled u-nav-3"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/Home/admin" style="padding: 10px;">ADMINISTRATION TOOL</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/views/ADMINSTATION_TOOL/HOME.jsp" style="padding: 10px;">HOME</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="#" style="padding: 10px;">VIDEO</a><div class="u-nav-popup"><ul class="u-border-1 u-border-palette-3-light-1 u-h-spacing-9 u-nav u-unstyled u-v-spacing-5 u-nav-4"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="VIDEO.jsp">VIDEO EDITION</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/VideosManagementServlet">VIDEO LIST</a>
</li></ul>
</div>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/UsersManagementServlet" style="padding: 10px;">USERS</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/views/ADMINSTATION_TOOL/REPORTS.jsp" style="padding: 10px;">REPORTS</a>
</li></ul>
              </div>
            </div>
        ...
        <form action="#" method="get" class="u-border-1 u-border-palette-3-light-1 u-search u-search-left u-white u-search-1">
          <button class="u-search-button" type="submit">
            <span class="u-icon-rectangle u-palette-3-base u-search-icon u-spacing-10 u-text-body-alt-color u-search-icon-1">
    ...
    <section class="u-clearfix u-palette-3-base u-section-1" id="carousel_c874">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-expanded-width u-table u-table-responsive u-table-1">
        <form action="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/VideosManagementServlet" method="POST" >
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-align-center u-black u-custom-font u-heading-font u-table-header u-table-valign-top u-table-header-1">
              <tr style="height: 45px;">
                <th class="u-table-cell">YOUTBE ID</th>
                <th class="u-table-cell">VIDEO LIST</th>
                <th class="u-table-cell">VIEW COUNT</th>
            ...
            <tbody class="u-align-center u-table-body">
             <c:forEach var="item" items="${videos }">
              <tr style="height: 78px;">
                ...
                <td class="u-border-2 u-border-grey-75 u-table-cell">${item.title }</td>
                <td class="u-border-2 u-border-grey-75 u-palette-3-light-1 u-table-cell u-table-cell-12">${item.views }</td>
                <td class="u-border-2 u-border-grey-75 u-table-cell"> ${item.description }</td>
                <td class="u-border-2 u-border-grey-75 u-palette-3-light-1 u-table-cell u-table-cell-13"><button formaction="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/VideosManagementServlet/edit/${item.id}" style="width:50px ;height:40px;background-color:white ; color:rgb(238,187,34) ;">Edit</button></td>
              </tr>
