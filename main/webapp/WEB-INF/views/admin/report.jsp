			...
			<div
				...
				<ul
					...
					<li class="u-tab-item" role="presentation"><a
						...
						aria-controls="tab-0da5" aria-selected="true">Report By
							Category</a></li>
					<li class="u-tab-item" role="presentation"><a
						...
						aria-controls="tab-14b7" aria-selected="false">Report Monthly
							Revenu</a></li>
					<li class="u-tab-item" role="presentation"><a
										...
										<table class="u-table-entity">
											...
											<thead
												...
												<tr style="height: 47px;">
													<th class="u-border-2 u-border-black u-table-cell">Category
														id</th>
													<th class="u-border-2 u-border-black u-table-cell">Category
														NAME</th>

													<th class="u-border-2 u-border-black u-table-cell">SUM</th>
													<th class="u-border-2 u-border-black u-table-cell">Quantity
														Product</th>
											...
											<table class="u-table-entity">
												...
												<thead
													...
													<tr style="height: 47px;">
														...
														<th class="u-border-2 u-border-black u-table-cell">SUM
															PRICE</th>
												...
												<tbody class="u-table-body">
													<c:forEach var="item" items="${itemsMT}">
														<tr style="height: 47px;">
															<td
																class="u-border-2 u-border-grey-90 u-table-cell u-table-cell-5">${item.month}</td>
