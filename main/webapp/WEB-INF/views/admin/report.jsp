...
<link rel="stylesheet" href="/admin/REPORTS.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-b689"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-gradient u-section-1" id="carousel_0e48" >
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1" style="width: 80%">
        <div class="u-expanded-width u-tab-links-align-justify u-tabs u-tabs-1 ">
          <ul class="u-border-2 u-border-palette-2-base u-spacing-10 u-tab-list u-unstyled" role="tablist">
            <li class="u-tab-item" role="presentation">
              <a class="active u-active-black u-button-style u-tab-link u-text-active-white u-text-hover-palette-2-base u-tab-link-1" id="link-tab-0da5" href="#tab-0da5" role="tab" aria-controls="tab-0da5" aria-selected="true">Report By Category</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-black u-button-style u-tab-link u-text-active-white u-text-hover-palette-2-base u-tab-link-2" id="link-tab-14b7" href="#tab-14b7" role="tab" aria-controls="tab-14b7" aria-selected="false">Report  Monthly Revenu</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-black u-button-style u-tab-link u-text-active-white u-text-hover-palette-2-base u-tab-link-3" id="link-tab-2917" href="#tab-2917" role="tab" aria-controls="tab-2917" aria-selected="false">Successful Delivery</a>
            </li>
          </ul>
                  ...
                  <div class="u-container-layout">
                    ...
                    <div class="u-expanded-width u-table ">
                      ...
                      <table class="u-table-entity">
                        ...
                        <thead class="u-custom-font u-heading-font u-table-header u-table-header-1">
                        
                          <tr style="height: 47px;">
                            <th class="u-border-2 u-border-black u-table-cell">Category id</th>
                            <th class="u-border-2 u-border-black u-table-cell">Category NAME</th>
                             
                            <th class="u-border-2 u-border-black u-table-cell">SUM</th>
                            <th class="u-border-2 u-border-black u-table-cell">Quantity Product </th>
                        ...
                        <tbody class="u-table-body">
                          ...
                          <tr style="height: 47px;">
                            <td class="u-border-2 u-border-grey-90 u-table-cell u-table-cell-5">${item.id}</td>
                            <td class="u-border-2 u-border-grey-90 u-table-cell">${item.name}</td>
                            <td class="u-border-2 u-border-grey-90 u-palette-3-light-3 u-table-cell u-table-cell-7"> ${item.sum}</td>
                            
                            <td class="u-border-2 u-border-grey-90 u-palette-3-light-3 u-table-cell u-table-cell-7"> ${item.count}</td>
              ...
              <div class="u-container-layout u-valign-top u-container-layout-3">
                <div class="u-container-style u-expanded-width u-group u-group-2">
                  <div class="u-container-layout">
                    ...
                    <form action="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/ReportManagementServlet" method="get" >
                      ...
                      <table class="u-table-entity">
                        ...
                        <thead class="u-custom-font u-heading-font u-table-header u-table-header-2">
                           <tr style="height: 47px;">
                            <th class="u-border-2 u-border-black u-table-cell">Month</th>
                            <th class="u-border-2 u-border-black u-table-cell">SUM PRICE</th>
                             
                            <th class="u-border-2 u-border-black u-table-cell">COUNT</th>
                        ...
                        <tbody class="u-table-body">
                          ...
                          <tbody class="u-table-body">
                          <c:forEach var="item" items="${itemsMT}">
                          <tr style="height: 47px;">
                            <td class="u-border-2 u-border-grey-90 u-table-cell u-table-cell-5">${item.month}</td>
                            <td class="u-border-2 u-border-grey-90 u-table-cell">${item.sum}</td>
                            <td class="u-border-2 u-border-grey-90 u-palette-3-light-3 u-table-cell u-table-cell-7"> ${item.count}</td>
                  ...
                  <div class="u-container-layout">
                    <div class="u-form u-form-3">
                      <form action="#" method="POST" class="u-clearfix u-form-horizontal u-form-spacing-15 u-inner-form" style="padding: 15px;" source="custom">
                        ...
                        <div class="u-form-group u-form-submit">
                          <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-hover-grey-90 u-black u-text-white u-btn-3">Submit</a>
                    ...
                    <div class="u-expanded-width u-table u-table-responsive u-table-3">
                      <table class="u-table-entity">
                        ...
                        <thead class="u-custom-font u-heading-font u-table-header u-table-header-2">
                           <tr style="height: 47px;">
                            <th class="u-border-2 u-border-black u-table-cell">Bill id</th>
                            <th class="u-border-2 u-border-black u-table-cell">FULL NAME</th>
                            ...
                            <th class="u-border-2 u-border-black u-table-cell">Customer id</th>
                          </tr>
                        </thead>
                        <tbody class="u-table-body">
                          ...
                          <tr style="height: 47px;">
                            ...
                            <td class="u-border-2 u-border-grey-90 u-palette-3-light-3 u-table-cell u-table-cell-7"> ${item.createDate}</td>
                            
                            <td class="u-border-2 u-border-grey-90 u-palette-3-light-3 u-table-cell u-table-cell-7"> ${item.address}</td>
                            <td class="u-border-2 u-border-grey-90 u-palette-3-light-3 u-table-cell u-table-cell-7"> ${item.price}</td>
                            <td class="u-border-2 u-border-grey-90 u-palette-3-light-3 u-table-cell u-table-cell-7"> ${item.phoneRe}</td>
                            <td class="u-border-2 u-border-grey-90 u-palette-3-light-3 u-table-cell u-table-cell-7"> ${item.orderstatus.name}</td>
                            <td class="u-border-2 u-border-grey-90 u-palette-3-light-3 u-table-cell u-table-cell-7"> ${item.customer.id}</td>
                            <td class="u-border-2 u-border-grey-90 u-table-cell" > 
                             <a   href="/admin/orderdetail/${item.id}" class="u-align-right u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn   u-palette-4-base u-none u-text-black u-btn-23" ><span class="u-file-icon u-icon u-icon-16"><img src="images/10591571.png" alt=""></span>&nbsp;DETAIL
              				</a>
                             </td>
                             <td class="u-border-2 u-border-grey-90 u-table-cell" >  
                             <a href="/admin/orderupdate/tc/${item.id }" class="u-align-right u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn  u-palette-4-base u-none u-text-black u-btn-23"><span class="u-file-icon u-icon u-icon-16"><img src="images/10591571.png" alt=""></span>&nbsp;Success
              				</a>
                             </td>
                          </tr>
						</c:forEach>	
    ...
    <section class="u-backlink u-clearfix u-grey-80">
      ...
      <a class="u-link" href="" target="_blank">
        ...
        <section class="u-align-center u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-section-5" id="carousel_9e37">
      <div class="u-align-center u-container-style u-dialog u-image u-radius-13 u-shape-round u-image-1" data-image-width="1434" data-image-height="1100">
        <div class="u-container-layout u-container-layout-1">
         <span class="u-file-icon u-icon u-icon-circle u-text-palette-1-base u-icon-1"><img src="/admin/img/logo.png" ></span>
          <h2 class="u-custom-font u-font-oswald u-text u-text-body-alt-color u-text-2">ORDER ARE BEING DELIVERED DEATIL</h2>
          <div class="u-expanded-width u-form u-form-1">
            <form action="#" method="POST" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 11px;" source="custom">
             <div class="u-expanded-width u-table u-table-responsive u-table-3" >
              <table class="u-table-entity u-white">
                        <colgroup>
                          <col width="25%">
                          <col width="25%">
                          <col width="25%">
                        ...
                        <thead class="u-custom-font u-heading-font u-table-header u-table-header-2">
                          <tr style="height: 47px;">
                            <th class="u-border-2 u-border-black u-table-cell">username</th>
                            <th class="u-border-2 u-border-black u-table-cell">fullname</th>
                            <th class="u-border-2 u-border-black u-table-cell">email</th>
                            <th class="u-border-2 u-border-black u-table-cell">favorite date</th>
                            <th class="u-border-2 u-border-black u-table-cell">username</th>
                            <th class="u-border-2 u-border-black u-table-cell">fullname</th>
                            <th class="u-border-2 u-border-black u-table-cell">email</th>
                            <th class="u-border-2 u-border-black u-table-cell">favorite date</th>
                        ...
                        <tbody class="u-table-body">
                          ...
                          <tr style="height: 47px;">
                            <td class="u-border-2 u-border-grey-90 u-table-cell u-table-cell-21">${item.userid }</td>
                            <td class="u-border-2 u-border-grey-90 u-table-cell">${item.fullname }</td>
                            <td class="u-border-2 u-border-grey-90 u-palette-3-light-3 u-table-cell u-table-cell-23"> ${item.email }</td>
              ...
              <div class="u-align-center u-form-group u-form-submit"><br>
                <a href="#" class="u-active-palette-2-light-1 u-border-5 u-border-active-palette-2-light-1 u-border-hover-palette-2-light-1 u-border-palette-2-base u-btn u-btn-round u-btn-submit u-button-style u-custom-font u-font-oswald u-hover-palette-2-light-1 u-palette-2-base u-radius-50 u-text-active-white u-text-body-alt-color u-text-hover-white u-btn-1">SHARE<br>
                </a>
                <input type="submit" value="submit" class="u-form-control-hidden" wfd-invisible="true">
              </div>
              <div class="u-form-send-message u-form-send-success" wfd-invisible="true">#FormSendSuccess</div>
              <div class="u-form-send-error u-form-send-message" wfd-invisible="true">#FormSendError</div>
    ...
    <section class="u-align-center u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-section-5" id="carousel_9e36">
      <div class="u-align-center u-container-style u-dialog u-image u-radius-13 u-shape-round u-image-1" data-image-width="1434" data-image-height="1100">
        <div class="u-container-layout u-container-layout-1">
        <span class="u-file-icon u-icon u-icon-circle u-text-palette-1-base u-icon-1"><img src="/admin/img/logo.png" ></span>
          <h2 class="u-custom-font u-font-oswald u-text u-text-body-alt-color u-text-2">ORDER PENDING DETAIL</h2>
          <div class="u-expanded-width u-form u-form-1">
            <form action="#" method="POST" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 11px;" source="custom">
             <div class="u-expanded-width u-table u-table-responsive u-table-3" >
              <table class="u-table-entity u-white">
