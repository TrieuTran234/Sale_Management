                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        ...
                                        <input type="text" value="${item.fullname}" name="name" required="required">
                                    </div>
                                </div>
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" value="${item.address}" placeholder="Apartment, suite, unite ect (optinal)" name="address"  required="required">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Phone<span>*</span></p>
                                        <input type="number" value="${item.phone}" name="phone" required="required">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Email<span>*</span></p>
                                        <input type="email" value="${item.email}" name="email" required="required">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                <h4 class="order__title">Your order  <a href="/client/shoppingcart/index" class="site-btn">CONTINUE SHOPPINGCART</a></h4>
                                <div class="checkout__order__products">Product <span>Total</span></div>
                                <ul class="checkout__total__products">
                                  <c:forEach var="item" items="${items}">
                                   <a href="/client/order/remove/${item.id}">
                                    <i class="fa fa-close"></i></a> <li>01. ${item.name} <span>$ ${item.price} * ${item.qty} = ${item.price*item.qty}</span></li>
                                ...
                                <c:if test="${ empty checkcreate }">
									
                                    <div class="u-form-agree u-form-group u-form-group-5">
                  							<input type="checkbox" id="agree-3520" name="check" value="true" checked="checked" class="u-agree-checkbox" required="">
                  								<label for="agree-3520" class="u-label">Create an account?</label>
                					</div> <br>
                               </c:if>
                               <c:if test="${not empty checkcreate }">
									<div class="checkout__input__checkbox">
										<label for="acc-or">
                                        	Have an account? 
                                        	<input type="checkbox" id="acc-or" name="check" value="true" checked >
                                        	<span class="checkmark"></span>
                                    	</label>
                                    </div>
                               </c:if>
                                ...
                                <button formaction="/client/preorder" class="site-btn">PLACE ORDER</button>
                                <c:if test="${not empty error }">
									<br><div style="width: 300px; height: 80px; background-color:rgb(149, 0, 0); color:  white;padding: 10px;text-align: center;">*${error }*</div>
									</c:if>
                            </div>
                        </div>
                    </div>
