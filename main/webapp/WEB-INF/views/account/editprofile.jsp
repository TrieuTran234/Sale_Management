			...
			<div
				...
				<div
					...
					<div class="u-align-left u-form u-form-1">
						...
						<form:form action="/account/editprofile" method="POST"
							modelAttribute="item" class="" enctype="multipart/form-data"
							style="padding: 10px" source="custom" name="form">
							
							<div class="u-form-group u-form-name">
								<label for="name-3b9a" class=" u-label" wfd-invisible="true">ID</label>
								<form:input path="id" type="text" placeholder="ID"
									id="name-3b9a" readonly="true" name="id" value=""
									class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-black u-input u-input-rectangle u-text-black u-input-1"
									required="" />
							</div>


							<div class="u-form-group u-form-group-1 u-form-control-hidden">
								<label for="text-160a" class=" u-label">Password</label>
								<form:input type="password" path="password" id="text-160a"
									name="password" value=""
							...
							<div class="u-form-group u-form-name u-form-group-1">
								<label for="name-5a14" class="u-label" wfd-invisible="true">FULLNAME</label>
								<form:input path="fullname" type="text"
									placeholder="Enter your full Name" id="name-5a14"
									name="fullname"
							...
							<div class="u-form-group u-form-group-2">
								...
								<form:input path="email" type="email"
									placeholder="Enter your email" id="email-5a14" name="email"
									class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white"
									required="required" />
							</div>
							<br>
							<div class="u-form-group u-form-group-3">
								<label for="text-a33d" class="u-label">PHONE</label>
								<form:input path="phone" type="number"
									placeholder="Enter your number phone" id="text-a33d"
									name="phone"
									class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white" />
							</div>
							<br>
							<div class="u-form-email u-form-group u-form-group-4">
								<label for="text-014f" class="u-label">DATE OF BIRTH</label>
								<form:input path="dateofBirth" type="date" id="text-014f"
									name="dateofBirth"
									class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white"
									placeholder="Enter a your birthday" />
							</div>
							<br>
							<div class="u-form-email u-form-group u-form-group-4">
								<label for="text-014f" class="u-label">IMAGE<input
									type="text" name="image1" value="${item.image}" readonly="true"
									style="border: none;"></label> <input type="file"
									id="text-014f" name="photo"
									class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white"
							...
							<div class="u-form-email u-form-group u-form-group-4">
								...
								<form:textarea path="address" type="date" id="text-014f"
									name="address"
									class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white"
